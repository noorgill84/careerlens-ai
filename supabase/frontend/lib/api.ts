...
export const api = {
  ...
  careerInsights: (resumeId: string) =>
    request<{ recommended_roles: RoleRecommendation[] }>(`/api/career-insights?resume_id=${resumeId}`),
  history: () => request<{ history: unknown[] }>("/api/history"),
};
